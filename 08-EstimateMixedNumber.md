...
I will generate 100 tests using mixed reads from Kew. I will generate an array that equally use all different species. Also, I need a new candidate table in different hierarchies.
