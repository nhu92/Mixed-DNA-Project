...
def create_contour_plot(data, output_file, threshold):
    ...
    local_maxima_points = find_local_maxima_normalized(x, y, z, threshold)
...
def main():
    ...
    parser.add_argument('threshold', type=float, help='Threshold to identify optima (-1,1), -0.5 recommended')
    args = parser.parse_args()

    data = load_data(args.input_file)
    create_contour_plot(data, args.output_file, args.threshold)
