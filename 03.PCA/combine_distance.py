...
if __name__ == "__main__":
    ...
    parser.add_argument("input_pattern", help="Input pattern (wildcard) to match TSV files.")
    parser.add_argument("output_file", help="Output TSV file for results.")
    parser.add_argument("remove_string", help="String to remove from the first column.")
